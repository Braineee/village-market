...
$GLOBALS["config"] = array(
	...
	"session" => array(
		...
		'session_name' => 'villagemarket_admin',
...
if (empty($_SESSION['admin_security_token'])) {
    ...
    if (function_exists('mcrypt_create_iv')) {
        ...
        $_SESSION['admin_security_token'] = bin2hex(mcrypt_create_iv(32, MCRYPT_DEV_URANDOM));

    } else {

        $_SESSION['admin_security_token'] = bin2hex(openssl_random_pseudo_bytes(32));
